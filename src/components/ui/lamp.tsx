...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col overflow-hidden bg-zinc-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative -mt-50 flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-zinc-500 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-zinc-200 "
        ></motion.div>
