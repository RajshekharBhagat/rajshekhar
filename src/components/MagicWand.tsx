...
const MagicWand = ({position}:MagicWandProps) => {
  ...
  return (
    <motion.div style={{x:position.x,y:position.y,rotate:rotate, transformOrigin:'top'}} initial={{x:0,y:0}} transition={{duration:0.45}} className='absolute hidden lg:flex pointer-events-none z-[9999] top-0 left-0 flex-col'>
